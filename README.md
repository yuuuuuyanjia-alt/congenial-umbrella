...
| N3 | 销售合同/订单确认 | **销售/出口合同**与采购合同分开签订。相对方只读带自 N1。金额可选 **CNY / USD**（占用不换汇，仅美元计入美元占用；限额仍登记美元）。**运输术语**仅 FOB / CIF，与**结算方式**（前 T/T / 后 T/T）独立。数量单位吨/千克。交货方式自有仓 / 港口直出；直出填仓储地点、批次号。前 T/T 登记收汇凭证、收汇金额与比例。**CIF 装运在 N6**。销售合同列表按 **未出运 / 已出运 / 已完成** 分组 |
