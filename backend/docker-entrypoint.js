    ...
    if (force || count === 0) {
      console.log(
        force
          ...
          : '[demo] 空库，写入 DEMO-PASS / DEMO-NORD-LATE / DEMO-NORD-OPEN / DEMO-NORD-WIP / DEMO-SOFT / DEMO-BLOCK / DEMO-GATE / DEMO-FOB / DEMO-LIMIT / DEMO-LIMIT-MED / DEMO-LIMIT-HIGH / DEMO-SUPPLIER',
      );
