...
export const NODE_CATALOG = [
  ...
  },
  {
    ...
    isHardGate: false,
    isStub: false,
    summary: '销售/出口合同与采购合同分开签订。买方与收货人在本节点填写并完成制裁/不可靠实体筛查，须通过后才能推进；不再单设询盘 KYC 页。销售合同金额可选人民币或美元；中信保限额仍登记美元，占用不换汇，仅美元销售计入美元占用池，人民币合同展示原币并提示暂不计入美元占用。运输术语仅 FOB / CIF，与前 T/T / 后 T/T 独立。后 T/T 填写到达目的港后付款天数。交货方式为自有仓或港口直出；直出填仓储地点、批次号。货物名称与规格默认可从报价带入，与采购合同各自保存。销售合同填写装运港与装运期限（与装运页 CIF 装运港口、装运日期分开）。中信保保单上传文件并写入证据链。CIF 装运节点在装运页办理。',
  },
  {
    code: 'N4',
    name: '变更管理',
  ...
  },
  {
    ...
    isHardGate: false,
    isStub: false,
    summary: '采购合同与销售合同分开签订。采购合同/PO 金额固定人民币。公司惯例先销售后采购：须关联一笔已达 N3 且已签的销售/出口合同，否则不得保存或推进；登记国内供应商、采购合同/PO、供应商实际交付日期与实际交付日期。货款可一次性付清或分期支付：一次性付清不登记已付货款与付款日期；分期每一期仍登记本期已付与付款日。供应商须过制裁/不可靠实体筛查；供应商实际交付日期或实际交付日期任一不得晚于关联销售合同交货期，除非已登记结构化延期并保留客户同意证据。交货方式只读同步自关联销售合同；港口直出薄利须退税·融资性工作台审核。',
  },
  {
    code: 'N6',
    name: '装运/提单指示',
