...
export const NODE_CATALOG = [
  ...
  },
  {
    ...
    isHardGate: false,
    isStub: false,
    summary: '销售/出口合同与采购合同分开签订。销售合同金额可选人民币或美元；中信保限额仍登记美元，占用不换汇，仅美元销售计入美元占用池，人民币合同展示原币并提示暂不计入美元占用。运输术语仅 FOB / CIF，与前 T/T / 后 T/T 独立。交货方式为自有仓或港口直出；直出填仓储地点、批次号。货物名称与规格自询盘/报价带入。CIF 装运节点在装运页办理。',
  },
  {
    code: 'N4',
    name: '变更管理',
