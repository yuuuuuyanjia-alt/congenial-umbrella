...
export const NODE_CATALOG = [
  ...
  },
  {
    ...
    isHardGate: false,
    isStub: false,
    summary: '销售/出口合同与采购合同分开签订。所有权保留与争议解决条款必填；中信保限额未登记不得签订销售合同；须上传保单并登记投保限额；按买方占用测算（未履行完毕未回款+已履行完毕未回款+新签合同），超额分档提示或拦截。CIF/CIP 可登记装运港、装运日期、预计到港货物状态；FOB 等登记国内段到达口岸/港口时间（到达即完成国内交付）。客户是否提货与约定客户付款日期、是否收汇、收汇/未收汇金额适用于全部术语（未收汇=合同总额−收汇金额）。销售合同列表按未出运/已出运/已完成分组。',
  },
  {
    code: 'N4',
    name: '变更管理',
