  ...
  async catalog() {
    ...
    return {
      ...
      sales: {
        ...
        n3: '运输术语仅 FOB / CIF，与结算方式（前 T/T / 后 T/T）独立。销售合同金额可选人民币或美元。交货方式为自有仓或港口直出；直出填货物仓储地点、批次号、电子底账编号。货物名称与规格自询盘/报价带入。CIF 装运（含货物状态）在装运页办理。前 T/T 登记收汇凭证、收汇金额与比例。',
      ...
      taxFinance: {
        ...
        ft2: '选择港口直出须填写货物仓储地点、批次号、电子底账编号，否则 409',
