...
export class CatalogController {
  ...
  async catalog() {
    ...
    return {
      ...
      suppliers: {
        label: '供应商管理',
        note: '按国内供应商聚合 N5 采购合同/PO。每笔采购展示关联的销售合同（客户、合同号、金额、状态）、是否按期交货、货款分期（比例/金额、付款条件、已付未付、是否过约定付款日），以及已付/未付汇总。',
      },
      procurement: {
        label: '采购合同/国内备货',
        n5: '销售合同与采购合同分开签订。公司惯例先销售后采购：保存或推进采购须关联一笔已达 N3 且已签的销售/出口合同。登记国内供应商、采购合同/PO、计划到货与货款支付计划（一次性付清或分期，如到货 90% + 尾款 10%）；供应商须过制裁/不可靠实体筛查；计划到货不得晚于客户合同交期，否则须结构化延期并保留客户同意证据',
