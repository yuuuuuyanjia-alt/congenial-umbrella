...
export class CatalogController {
  ...
  async catalog() {
    ...
    return {
      ...
      procurement: {
        label: '采购合同/国内备货',
        n5: '销售合同与采购合同分开签订。公司惯例先销售后采购：保存或推进采购须关联一笔已达 N3 且已签的销售/出口合同。登记国内供应商、采购合同/PO、供应商实际交付日期与实际交付日期、付款方式（一次性付清或分期支付；分期每一期须填约定付款时间、付款比例、金额）；供应商须过制裁/不可靠实体筛查；供应商实际交付日期或实际交付日期任一不得晚于关联销售合同交货期，否则须结构化延期并保留客户同意证据',
